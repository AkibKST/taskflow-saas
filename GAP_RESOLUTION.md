...
| §2.4 Zero tests | ✅ | Vitest suite (17 tests) for security-relevant pure logic (mentions, invoice numbering, pagination clamps, template escaping); run in CI. | `src/utils/__tests__/*`, `vitest.config.ts`, `.github/workflows/ci.yml` |
